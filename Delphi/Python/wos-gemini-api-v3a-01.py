...
async def main():
    ...
    directory = os.path.join(
        "C:\\Development\\WOS\\wosGeminiAPI\\Delphi\\Binary\\", "results"
    )
    ...
    prompt = """create four images of chinese panda eating bamboo in the forest and tiger walking with childrens, realist, texture, more details, panoramic perspective, photorealistic, ultra-realistic, high-definition, cinematic, photographic, hdr, 8k"""
